...
### Висновок
Під час виконання лабораторної роботи №3 було практично застосовано мову SQL для виконання типових операцій OLTP-системи. Я навчилася:

Формувати складні вибірки з декількох таблиць за допомогою оператора JOIN.

Використовувати підзапити для забезпечення логічної цілісності при додаванні даних.

Коректно оновлювати та видаляти дані, враховуючи обмеження (constraints) бази даних.
Робота з pgAdmin дозволила відстежити зміни в реальному часі та переконатися в правильності написаних скриптів.
